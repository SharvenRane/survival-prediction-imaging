"""
Survival Prediction Imaging - Dataset
"""
import os
import torch
...
class SurvivalPredictionImagingDataset(Dataset):
    """Dataset for survival prediction imaging."""
...
def get_dataloader(root, split, config):
    ...
    dataset = SurvivalPredictionImagingDataset(root, split, transform)
    return DataLoader(
        dataset,
